...
class Version20170119212421 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        $this->addSql([
            ...
            'CREATE TABLE arrows.scenario_template (id UUID NOT NULL, author UUID NOT NULL, name VARCHAR(255) NOT NULL, nbSequences INT NOT NULL, scenario_sequences JSON NOT NULL, PRIMARY KEY(id))',
